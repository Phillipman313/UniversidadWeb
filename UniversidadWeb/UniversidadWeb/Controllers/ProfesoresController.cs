...
namespace UniversidadWeb.Controllers
{
    public class ProfesoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Profesor,CodProfesor,Nombre,Apellido1,Apellido2")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Profesor,CodProfesor,Nombre,Apellido1,Apellido2")] Profesor profesor)
        {
            if (ModelState.IsValid)
            {
